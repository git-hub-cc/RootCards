...
*   **核心技术**:
    ...
    *   **Fetch API**: 异步加载词汇数据。
    *   **HTML5 Audio & 离线音频缓存**: 播放预先生成的本地音频文件，保证跨平台体验一致性。
